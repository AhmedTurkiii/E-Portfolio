      ...
      <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4 pt-24 pb-12">
        ...
        <div className="mt-8 flex justify-between items-stretch flex-wrap">
          ...
          <Card
            ...
            description="Participated in a team of 4 contributors to create a responsive and consumer-friendly website using PHP, MySQL, HTML5, CSS3, Bootstrap, jQuery, and JavaScript."
          ...
          <Card
            ...
            description="Built a movie app using MVVM architecture, Retrofit for networking, and Dagger Hilt for dependency injection."
            techStack="Kotlin, MVVM, Retrofit, Dagger Hilt, RESTful API"
